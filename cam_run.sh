...
mjpg_streamer -i '/usr/local/lib/mjpg-streamer/input_file.so -e -f /home/pi/arp' -o '/usr/local/lib/mjpg-streamer/output_http.so -w /home/s/mjpg-streamer/mjpg-streamer-experimental/www -p 8080'
